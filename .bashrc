...
if [ -x /usr/bin/figlet ]; then
    /usr/bin/figlet -fcosmic -w180 ${HOSTNAME} | lolcat
    echo
    echo
fi
...
complete -f -o default -X '!*.@(mp?(e)g|MP?(E)G|wma|avi|AVI|asf|vob|VOB|bin|dat|vcd|ps|pes|fli|viv|rm|ram|yuv|mov|MOV|qt|\
